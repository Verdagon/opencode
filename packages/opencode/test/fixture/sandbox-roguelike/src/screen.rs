...
impl Screen {
    ...
    fn paint_cell(&self, x: usize, y: usize) {
        ...
        let (fg_red, fg_green, fg_blue) = match cell.bg_color {
        ...
        let (bg_red, bg_green, bg_blue) = match cell.fg_color {
            ScreenColor::Red => (255, 0, 0),
        ...
        println!(
            ...
            bg_red, bg_green, bg_blue, fg_red, fg_green, fg_blue, character
        );
    }
}
